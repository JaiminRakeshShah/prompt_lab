...
12. Write `docs/day1-observations.md` in no more than three sentences. Compare the shortest and longest cases by input-token count and latency, then state what that tells you about estimating model workload from only a short documen
